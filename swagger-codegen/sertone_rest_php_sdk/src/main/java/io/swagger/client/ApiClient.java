...
public class ApiClient {
  ...
  private String basePath = "http://api.dds.sertone.com/v1";
  ...
  public ApiClient() {
    ...
    authentications.put("server_token", new ApiKeyAuth("header", "Authorization"));
    authentications.put("client_id", new ApiKeyAuth("header", "ClientID"));
