...
class TestApplicationsApi(unittest.TestCase):
    ...
    def test_get_applications_by_user_id(self):
        """
        Test case for get_applications_by_user_id

        getApplicationsByUserId() - Gets all applications owned by given user.
        """
        pass

    def test_get_applications_by_user_id_and_app_id(self):
        """
        Test case for get_applications_by_user_id_and_app_id
