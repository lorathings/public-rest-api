...
from swagger_client.apis.nodes_api import NodesApi
...
class TestNodesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.nodes_api.NodesApi()

    def tearDown(self):
        pass

    def test_get_nodes_by_user_id(self):
        """
        Test case for get_nodes_by_user_id

        getNodesByUserId() - Gets all nodes owned by given user.
        """
        pass

    def test_get_nodes_by_user_id_and_sensor_id(self):
        """
        Test case for get_nodes_by_user_id_and_sensor_id
