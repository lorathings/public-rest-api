...
Gem::Specification.new do |s|
  ...
  s.email       = ["email@sertone.com"]
  s.homepage    = "https://github.com/swagger-api/swagger-codegen"
  s.summary     = "SERTONE REST API Ruby Gem"
  s.description = "This is the SERTONE REST API server for the  Sertone IOT Developers.  You can find out more about IOT at [http://www.sertone.com](http://www.sertone.com) or about the API on [API Reference](http://dev.sertone.com/public-rest-api)."
