...
class SystemApi
{
     ...
     */
    public function getSystemHealthz()
    {
        list($response) = $this->getSystemHealthzWithHttpInfo();
        return $response;
    }


    /**
     * Operation getSystemHealthzWithHttpInfo
     *
     * getSystemHealthz() - Gets status health of the api server.
     *
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSystemHealthzWithHttpInfo()
    {
        
        // parse inputs
        $resourcePath = "/system/healthz";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
