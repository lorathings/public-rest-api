...
class DataApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test case for getAppDevDataPayload
     *
     * getAppDevDataPayload() - Gets payload data of given application and device..
     *
     */
    public function testGetAppDevDataPayload()
    {

    }
    /**
     * Test case for getAppDevLastDataTimestamp
     *
     * getAppDevLastDataTimestamp() - Gets last data timestamp for a given application and device..
     *
     */
    public function testGetAppDevLastDataTimestamp()
    {

    }
    /**
     * Test case for getAppDevLatestCounter
     *
     * getAppDevLatestCounter() - Gets the latest counter for a given application and device..
     *
     */
    public function testGetAppDevLatestCounter()
    {

    }
    /**
     * Test case for getAppLastDataMethod
     *
     * getAppLastDataMethod() - Gets last data delivery method for a given application..
     *
     */
    public function testGetAppLastDataMethod()
    {

    }
    /**
     * Test case for getAppLastDataTimestamp
     *
     * getAppLastDataTimestamp() - Gets last data timestamp for a given application..
     *
     */
    public function testGetAppLastDataTimestamp()
    {
