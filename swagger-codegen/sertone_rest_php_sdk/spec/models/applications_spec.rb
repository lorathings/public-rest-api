...
# Unit tests for SwaggerClient::Applications
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Applications' do
  before do
    # run before each test
    @instance = SwaggerClient::Applications.new
  end
  ...
  describe 'test an instance of Applications' do
    it 'should create an instact of Applications' do
      expect(@instance).to be_instance_of(SwaggerClient::Applications)
    end
  end
  ...
  describe 'test attribute "access_keys"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
