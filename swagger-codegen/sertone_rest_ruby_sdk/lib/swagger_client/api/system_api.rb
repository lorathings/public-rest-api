...
module SwaggerClient
  class SystemApi
    ...
    # @return [String]
    def get_system_healthz(opts = {})
      data, _status_code, _headers = get_system_healthz_with_http_info(opts)
      return data
    end
    ...
    def get_system_healthz_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SystemApi.get_system_healthz ..."
      end
      # resource path
      local_var_path = "/system/healthz".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'String')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SystemApi#get_system_healthz\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
