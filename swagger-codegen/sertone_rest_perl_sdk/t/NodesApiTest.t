...
use_ok('WWW::SwaggerClient::NodesApi');

my $api = WWW::SwaggerClient::NodesApi->new();
isa_ok($api, 'WWW::SwaggerClient::NodesApi');

#
# get_nodes_by_user_id test
#
{
    my $user_id = undef; # replace NULL with a proper value
    my $result = $api->get_nodes_by_user_id(user_id => $user_id);
}

#
# get_nodes_by_user_id_and_sensor_id test
#
{
    my $user_id = undef; # replace NULL with a proper value
    my $dev_eui = undef; # replace NULL with a proper value
    my $result = $api->get_nodes_by_user_id_and_sensor_id(user_id => $user_id, dev_eui => $dev_eui);
}
