...
use_ok('WWW::SwaggerClient::SystemApi');

my $api = WWW::SwaggerClient::SystemApi->new();
isa_ok($api, 'WWW::SwaggerClient::SystemApi');

#
# get_system_healthz test
#
{
    my $result = $api->get_system_healthz();
}
