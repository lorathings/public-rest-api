...
#
package WWW::SwaggerClient::Object::GatewaysStatus;
...
__PACKAGE__->method_documentation({
    ...
    'gateway_activity' => {
    	datatype => 'string',
    	base_name => 'gateway_activity',
    	description => 'Gateway activity can be Active, Inactive, Not Found',
    	format => '',
    	read_only => '',
    		},
    'last_pull_data' => {
    	datatype => 'string',
    	base_name => 'last_pull_data',
    	description => '',
    	format => '',
    	read_only => '',
    		},
