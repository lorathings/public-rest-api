...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SertoneRestApi.SystemApi();
  });
  ...
  describe('SystemApi', function() {
    describe('getSystemHealthz', function() {
      it('should call getSystemHealthz successfully', function(done) {
        //uncomment below and update the code to test getSystemHealthz
        //instance.getSystemHealthz(pet, function(error) {
