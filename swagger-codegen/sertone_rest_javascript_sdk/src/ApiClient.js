...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SertoneRestApi.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://api.dds.sertone.com/v1
     */
    this.basePath = 'http://api.dds.sertone.com/v1'.replace(/\/+$/, '');
    ...
    this.authentications = {
      ...
      'server_token': {type: 'apiKey', 'in': 'header', name: 'Authorization'},
      'client_id': {type: 'apiKey', 'in': 'header', name: 'ClientID'}
    };
    /**
